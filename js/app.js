 ...
 */
    ...
    (() => {
        ...
        let formValidate = {
            ...
            validateInput(formRequiredItem) {
                ...
                if ("email" === formRequiredItem.dataset.required) {
                    ...
                    this.addError(formRequiredItem);
                    error++;
                } else if (formRequiredItem.classList.contains("form-popup__phone") && !exp.test(formRequiredItem.value)) {
                    this.addError(formRequiredItem);
                    error++;
        ...
        const inputMasks = document.querySelectorAll(".form-popup__phone");
        ...
        let navArr = document.querySelectorAll(".header__arrow");
        if (navArr && isMobile.any()) navArr.forEach((e => {
            e.addEventListener("click", (item => {
                item.target.closest(".header__menu").classList.toggle("_active");
            }));
        }));
        isWebp();
        formFieldsInit({
